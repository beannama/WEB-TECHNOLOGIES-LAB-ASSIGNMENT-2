...
class DumpstersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dumpster" do
    assert_difference('Dumpster.count') do
      post dumpsters_url, params: { dumpster: { date: @dumpster.date, post_id: @dumpster.post_id } }
    end
  ...
  test "should update dumpster" do
    patch dumpster_url(@dumpster), params: { dumpster: { date: @dumpster.date, post_id: @dumpster.post_id } }
